    ...
    function shareWX(str){
        return function(){
            wx.onMenuShareAppMessage({
                title: '美甲小技巧你造几个?', // 分享标题
                desc: str, // 分享描述
                link: 'http://huodong.naildaka.com/nishidaka/index3.html', // 分享链接
                imgUrl: 'http://huodong.naildaka.com/nishidaka/images/index3/share_icon.png', // 分享图标
                success: function () {
                    transparency.hide();
                },
                cancel: function () {
            ...
            wx.onMenuShareTimeline({
                title: '美甲小技巧你造几个?' + str,
                link: 'http://huodong.naildaka.com/nishidaka/index3.html',
                imgUrl: 'http://huodong.naildaka.com/nishidaka/images/index3/share_icon.png',
                success: function () {
                    transparency.hide();
                },
                cancel: function () {
